    ...
    <table class="mo_price-table">
        ...
        echo'                </td>
                                ...
                                <br><br><br><br>
                                 ...
                                 <br>Wordpress Registration & Contact Forms
                                 <br>Premium Support</div><br><br><br><br>';
                ...
                echo '
                                ...
                                <td class="mo_price"><div class="mo_charges">'.$enterprise_addon.'</div><br><br>
                                <div class="mo_plan_description"><br><br>
                                miniOrange + AWS SNS
                                <br> Twilio + Custom SMS Gateway
                                <br>Alphanumeric OTP
                                <br>Selected countries OTP
                                <br>Premium Support</div><br><br>';
                            ...
                            if(strcmp($plan,MoConstants::ECODE)==0 || strcmp($plan,MoConstants::ECODE2)==0)
                                        ...
                                        echo '<div class="mo_pricing_button"><input type="button" ' . mo_esc_string($disabled,"attr") . '
                                                ...
                                                <input style="margin-top:8px;background-color: rgb(252 211 77); color:black; border:none;" type="button" ' . mo_esc_string($disabled,"attr") . '
                                                    class="mo_dollar_price button button-primary button-large"
                                                    onclick="otpSupportOnClick(\'Hi! I want to purchase the Enterprise plan, can you please share the discounted price?\');"
                                                    value="' . mo_("Ask for extra seasonal discount") . '"/>
...
echo'  
    ...
    <div class="mo_registration_divided_layout mo-otp-full">
        <div class="mo_registration_pricing_layout mo-otp-center">
            <h3>'.mo_("Return Policy (Please read the refund policy before upgrading to any plan)").'</h3>
            ...
            <p>
                <ol>
                    <li>'.mo_("The plugin or the software is not working due to customer environmental changes").'</li>
                    <li>'.mo_("You no longer require the plugin after the purchase").'</li>
                    <li>
                        '.mo_("You are not able to make any custom changes into the licensed plugin").
                    '</li>
                    <li>
                        '.mo_("You have willingly purchased the plugin after taking the demo/trial from support team and if does not fit into your requirements").
                    '</li>
                </ol>
                Please email us at <a href="mailto:'.MoConstants::SUPPORT_EMAIL.'">'.MoConstants::SUPPORT_EMAIL.'</a> for any queries regarding the return policy. If you have any doubts regarding the licensing plans, you can mail us at <a href="mailto:'.MoConstants::SUPPORT_EMAIL.'">'.MoConstants::SUPPORT_EMAIL.'</a> or submit a query using the support form.
            </p>
        </div>
    </div>
