...
class MoOTPActionHandlerHandler extends BaseActionHandler
{
    ...
    if($isNoticeClosed !== "mo_hide_notice"){
      if((!strcmp(MOV_TYPE, "EnterpriseGatewayWithAddons")!==0) && ($current_url !== $licensePageUrl)){
        ...
        <p style ="font-size:14px;"><img src="'.MOV_FEATURES_GRAPHIC.'" class="show_mo_icon_form" style="width: 3%;margin-bottom: -1%;">&ensp;<b>We support OTP Verificationon 40+ forms, PasswordlLess Login, WooCommerce SMS Notifications for Admins, Vendors & Customers, Password Reset via OTP and many more.<br><br>AWS SNS, Twilio Gateway & more gateways supported! Want to know more? Check it out here : <a href='.$licensePageUrl.'>Plan Details</a>.</b></p>
         </div>';
       }
     }	
